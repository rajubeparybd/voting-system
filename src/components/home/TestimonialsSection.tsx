                        ...
                        <div className="flex flex-col items-center gap-8 md:flex-row">
                            ...
                            <div className="flex-1 rounded-xl bg-gray-800 p-8 shadow-lg">
                                ...
                                <p className="mb-8 text-gray-300 italic">
                                    ...
                                    confidence and expand my network. I have
                                    made amazing friends, participated in
                                    national competitions, and even landed an
                                    internship through club connections. If you
                                    want to grow beyond academics, joining a
                                    club is the best decision!
                                </p>
